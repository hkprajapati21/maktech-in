...
const Testimonial = () => {
  ...
  return (
    <section className="srex-testimonial-three srex-section">
      <div className="container">
        ...
        <div className="row justify-content-center align-items-center">
          <div data-aos="fade-up" className="col-12 col-lg-10 col-md-12 relative">
            <Slider
              ref={(slider) => {
                sliderRef = slider;
              }}
              {...settings}
              className="srex-testimonial-three__slider "
            >
              <div data-aos="fade-up" data-aos-delay="200" className="srex-testimonial-three__slider__item">
                <div className="srex-testimonial-three__slider__item__icon">
                  <i className="fa-solid fa-quote-right"></i>
                </div>
                <div className="srex-testimonial-three__slider__item__ratings">
                ...
                <div className="d-flex justify-content-between align-content-center">
                  <div className="srex-testimonial-three__slider__item__author">
                    <h3>MH Imon</h3>
                    <p>CEO, ultraDevs</p>
                  </div>
                </div>
                <p className="srex-testimonial-three__slider__item__text">Financial planners help people to knowledge in about how to invest and save their go to a moneye the most efficient way eve.planners help people to knowledge in about how.</p>
              </div>
              <div data-aos="fade-up" data-aos-delay="400" className="srex-testimonial-three__slider__item">
                <div className="srex-testimonial-three__slider__item__icon">
                  <i className="fa-solid fa-quote-right"></i>
                </div>
                <div className="srex-testimonial-three__slider__item__ratings">
              ...
              <div data-aos="fade-up" data-aos-delay="600" className="srex-testimonial-three__slider__item">
                <div className="srex-testimonial-three__slider__item__icon">
                  <i className="fa-solid fa-quote-right"></i>
                </div>
                <div className="srex-testimonial-three__slider__item__ratings">
            ...
            <div data-aos="fade-up" data-aos-delay="800" className="srex-testimonial-three__slider__nav">
              <div onClick={previous} className="srex-testimonial-three__slider__nav__prev">
              ...
              <div onClick={next} className="srex-testimonial-three__slider__nav__next">
